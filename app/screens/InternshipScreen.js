        ...
        <View style={styles.container}>
            <StatusBar style="auto" />
               <SafeAreaView>
                ...
                >Click on the {<Image source={require('../assets/graphics/alabama.jpg')} style={styles.image}/>} to 
                get more info!
                </Text>
               </SafeAreaView>
               ...
               we hope to bring you an extremely awesome feature soon, Roll Tide!</Text>
                <Image source={require('../assets/graphics/alabamaElephant.jpg')} style={{height: 50, width: 50, alignSelf: 'center', paddingTop: 5}} />
        </View>
    );
}
